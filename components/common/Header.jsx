    ...
    <SafeAreaView>
      <View>
        ...
        <View className="flex-row justify-between items-center mb-5">
          ...
          <TouchableOpacity
            activeOpacity={0.7}
            className="flex-row items-center max-w-[75%]"
          >
          ...
          <TouchableOpacity
            activeOpacity={0.7}
            className="flex-row items-center bg-app-color-red rounded-lg px-4 py-2"
        ...
        {/* Search Bar */}
        <View className="flex-row items-center bg-white border border-app-color-warmgreylight rounded-xl px-4 py-3 mb-5">
